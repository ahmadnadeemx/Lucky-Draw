          ...
          <table className="w-full min-w-[1200px]">
            <thead className="sticky top-0 z-20">
              <tr className="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900">
                {/* Removed sticky left from first column */}
                ...
                {/* Removed sticky right from last column */}
            ...
            <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
              {filteredMembers.length === 0 ? (
                ...
                filteredMembers.map((member) => (
                  ...
                  >
                    {/* Removed sticky left from first column cell */}
                    ...
                    {/* Removed sticky right from last column cell */}
