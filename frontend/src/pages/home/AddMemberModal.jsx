...
const AddMemberModal = ({ isOpen, onClose, onMemberAdded }) => {
  ...
  const validateForm = () => {
    ...
    // Mobile validation - Only required check
    if (!formData.mobile.trim()) {
      newErrors.mobile = "Mobile number is required";
    }
    
    // CNIC validation - Only required check
    if (!formData.cnic.trim()) {
      newErrors.cnic = "CNIC is required";
    }
    
    // Email validation - Only format check if provided
    if (formData.email && !/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(formData.email)) {
      newErrors.email = "Please enter a valid email address";
    }
    
    // Date of Birth validation - Only required check
    if (!formData.dob) {
        ...
        <>
          ...
          >
            ...
            <motion.div
              ...
              className="bg-gradient-to-br from-white via-gray-50 to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-slate-900 rounded-2xl shadow-2xl shadow-blue-500/20 dark:shadow-black/30 w-full max-w-4xl max-h-[90vh] overflow-hidden border border-white/20 dark:border-gray-700/30"
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-400 text-sm">
                        Register a new lucky draw participant
                      </p>
                    </div>
                  </div>
                  <motion.button
                    ...
                    <div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center gap-3 pt-4">
                          ...
                          />
                          <label htmlFor="bmVerification" className="text-sm font-medium text-gray-700 dark:text-gray-300">
